 ...
 *
These are the classes for portable pointers and types, shared across nodes to Gen-Z-style byte addressable shared memory across nodes (as in The Machine).
