/*
This is a the RAID 6 file for applications built using the TxHPC framwework, for shared access to Gen-Z-style byte addressable shared memory across nodes (as in The Machine).
