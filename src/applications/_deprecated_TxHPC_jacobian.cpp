...
#include <chrono>
#include "jacobian.h"
#include "include/TxHPC/TxHPC.h"

void kernel_jacobian2d_TxHPC(int x, int y, GridPointer gP, Grid<double> grid){
...
double jacobian2d_TxHPC(void** memoryPointer, int amountOfPointer, int x_axes, int y_axes, bool printGrid, int iterations){
